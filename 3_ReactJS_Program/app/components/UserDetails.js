...
// We are requiring React and PropTypes
var React = require("react")
var PropTypes = React.PropTypes


// Some of these items are not required. We are using JavaScript to say "If user.info.something is truthy then render that list item" 
...
// Define the proptypes that are required and the ones that are not
// .shape allows us to have proptypes based on the key values in your object
// In this case it is the "UserDetails" object
