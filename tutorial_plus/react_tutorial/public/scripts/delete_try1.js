...
var CommentRemove = React.createClass({
	...
	render: function(){
		var comments = this.props.data.map(function(comment, i){
			return (
				<li key={i}>
					<span>{comment.author}</span>
					<a href data-id={comment.id} className="remove-filter" onClick={this.remove(comment)}>remove</a>
				</li>
			)	
		}.bind(this));
